...
<div x-data="{
    ...
    <div x-show="show"
        class="mb-6 bg-white dark:bg-gray-100 text-black hover:bg-gray-200 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
