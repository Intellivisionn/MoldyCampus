<div class="container-fluid p-5" style="height: 75vh;">
    ...
    <div class="d-flex flex-column" style="height: 66%;">
        ...
        <div class="d-flex flex-column" style="height: 75%;">
            ...
            <div class="d-flex flex-row h-100">
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <img src="{{ file_exists(asset('images/courses/' . $professor->image_path))
                    ? asset('images/courses/' . $professor->image_path)
                    : asset('images/professors/no-image.jpg') }}" alt="Image" class="img-fluid rounded-circle" 
        ...
        <div class="d-flex flex-row" style="height: 25%;">
            <div class="col-4 d-flex align-items-center justify-content-center">
                <h1 class="fw-bold mb-0"> {{ $professor['name'] }}</h1>
            </div>
            <div class="col-8 align-items-center justify-content-around d-flex">
                <h4 class="mb-0"><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-regular fa-star"></i><i class="fa-regular fa-star"></i>
                    {{ $finalRating }}/5
                </h4>
